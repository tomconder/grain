...
// configuration step. It creates a namespace called `grain`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", grain::cmake::project_name, grain::cmake::project_version) };
